...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 28278})) then -- Strange Jeweler's Schematic
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(17277,28278)); -- item: Small Parts kit, Strange Jeweler's Schematic
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 28283})) then -- Sealed Parts Box
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(17278,28284)); -- Item: Small Parts Container, Small Clockwork Talisman
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 28289})) then
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(28291,28290)); -- Item: The Talisman Schematic, Powered Clockwork Talisman
	end
