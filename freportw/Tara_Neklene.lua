...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13845})) then
		...
		e.other:QuestReward(e.self,math.random(1,15),math.random(1,15),0,0,eq.ChooseRandom(13005,13007,13002,13006),250); -- Iron Ration, Ration, Torch, Water Flask  
	elseif(e.other:GetFactionValue(e.self) >= 200 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13225})) then
		...
		e.other:QuestReward(e.self,math.random(1,15),math.random(1,15),math.random(1,2),0,eq.ChooseRandom(15317,15058,15316,15315),500); -- Spells : Elementalkin Air, Earth, Fire, Water
	end
