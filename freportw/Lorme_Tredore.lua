function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13951})) then -- Fleshy Orb
		...
		e.other:QuestReward(e.self,0,math.random(1,10),math.random(1,10),0,eq.ChooseRandom(5350,5351,5352,5353,6350,6351,6352,7350,7351,7352),3000); -- random Fine Steel Weapons ; exp data confirmed
	end
