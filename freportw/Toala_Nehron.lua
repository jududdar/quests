...
function event_trade(e)
	...
	if(e.other:GetFaction(e.self) < 5) then
		...
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 12246})) then -- Box with Two Heads
			...
			e.other:QuestReward(e.self,0,math.random(0,10),math.random(0,5),math.random(0,1),eq.ChooseRandom(2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,9002),2000)
		end
	elseif(e.other:GetFaction(e.self) == 5) then
