...
function event_trade(e)	
	...
	if(sash > 0) then
		...
		e.other:QuestReward(e.self,math.random(1,10),math.random(1,10),math.random(1,15),math.random(0,1),eq.ChooseRandom(7012,7013,7014,7015,7016,5026,5027,5028,5029,5030,5031,5032,5033,5034,5035,5036,5037,6019,6021,6022,6023,6024,9002),8100);
			sash = sash - 1;
		until sash == 0
	end	
