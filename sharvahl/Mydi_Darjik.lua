...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3495})) then
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(3495,5538)); -- Item: Large Folded Cloth
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 5543})) then
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(5543,17076)); -- Item: Imbued Hopperhide Buckler
