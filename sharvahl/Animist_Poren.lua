...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 2877})) then --Acrylia Slate of Shar Vahl
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(17237,2877,3663)); --Khati Sha Handwrap Pattern, Stitching Pack, Acrylia Slate of Shar Vahl
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 3668, item2 = 3669, item3 = 2878})) then --Primary Silk Khati Sha Recruit Claw, Secondary Silk Khati Sha Recruit Claw, Initiate's Cloak of Shar Vahl
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(3673,3674,3670,3675),500); --Seal of Animist Poren, Primary Khati Sha Recruit Claw, Secondary Khati Sha Recruit Claw , Cloak of the Khati Sha Recruit
