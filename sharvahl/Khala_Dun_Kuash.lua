...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 5550})) then
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(5550,17114)); -- Item: Horn Covered Buckler
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 6221})) then
		...
		e.other:Faction(e.self,1513,1); -- Faction: Guardians of Shar Vahl
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(6141,6142,6148),1000); -- Item: Blade Mold, Claw Mold
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 5557, item2 = 6158})) then
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(6222,6158),10000); -- Item: Cloak of the Khala Dun Journeyman
	end
