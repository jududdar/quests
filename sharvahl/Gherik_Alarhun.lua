...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 3648, item2 = 3648, item3 = 3648}, 0)) then
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(17235,3651)); -- Item: Claymixing Bowl
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 3654, item2 = 2878, item3 = 3655, item4 = 3656})) then
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(3657,3658,36590),1000);  -- Item: Drum of the Jharin Recruit, Cloak of the Jharin Recruit
	end
