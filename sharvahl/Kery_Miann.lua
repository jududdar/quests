...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 5571})) then
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(17237,5572)); -- Item: Stitching Pack
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 5581, item2 = 5581, item3 = 3673, item4 = 3674})) then
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(5574,5575,5573),2500); -- Item: Reinforced Khati Sha Claw
