...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 2877})) then
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(2877,17231)); -- Item: Acrylia Slate of Shar Vahl
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 3461})) then
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(3463,3463,3463,3464)); -- Item: Xakra tooth dart
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 3467})) then
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(3467,3471)); -- Item: Xakra Dart Crafting Tool
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 3472})) then --Grimling Dart Crafting Tool
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(3472,3473)); --Grimling Dart Crafting Tool, Crafting Tool Hook Attachment
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 3474})) then
		...
		e.other:QuestReward(e.self,0,0,0,0,GiveAll(3474,3477)); -- Item: Rockhopper Dart Crafting Tool
	end
