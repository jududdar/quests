...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 20419}) and expansion_flag >= 4.0) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 20415, item2 = 20355, item3 = 20402}) and expansion_flag >= 4.0) then
