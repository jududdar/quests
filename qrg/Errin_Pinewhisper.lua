...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 19949}) and expansion_flag >= 4.0) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 20104,item2 = 13915, item3 = 19945}) and expansion_flag >= 4.0) then
