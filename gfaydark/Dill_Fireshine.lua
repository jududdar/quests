...
function event_trade(e)
	...
	if(e.other:GetFactionValue(e.self) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 12108,item2 = 12108},1,text)) then -- Orc Hatchet x 2
		...
		e.other:QuestReward(e.self,math.random(10),math.random(20),0,0,eq.ChooseRandom(5047,5048,7032,5046),2500); -- Tarnished Scimitar, Tarnished Bastard Sword, Cast-Iron Rapier, Tarnished Battle Axe
