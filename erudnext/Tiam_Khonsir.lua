...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 1761})) then -- Kobold Molar
		...
		e.other:QuestReward(e.self,0,0,0,0,0,3800); -- confirmed exp data
