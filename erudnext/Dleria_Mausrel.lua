...
function event_trade(e)
	...
	if(e.other:GetFactionValue(e.self) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13922})) then -- requires amiably
		...
		e.other:QuestReward(e.self,0,math.random(1,20),math.random(1,10),0,eq.ChooseRandom(2144,2146,2147,17005),4000); -- Item(s): Raw-hide Sleeves (2144), Raw-hide Gloves (2146), Raw-hide Leggings (2147), Backpack (17005)
