...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 9931,item2 = 9932, item3 = 9932}) and expansion_flag >= 4.0) then -- A Torn Qeynos Newsletter and Pristine Scarab Eyes 2x
