...
function event_trade(e)
	...
	if(e.other:GetFactionValue(e.self) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13054, item2 = 13054, item3 = 13054, item4 = 13054},1,text)) then -- Giant Rat Pelt
		...
		e.other:QuestReward(e.self,0,0,math.random(1,5),0,eq.ChooseRandom(13036,1051,13003,13002,10015,13009),4200); -- verified live xp
	elseif(e.other:GetFactionValue(e.self) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13282})) then -- Scrap Metal
		...
		e.other:QuestReward(e.self,math.random(1,10),0,0,0,13995,5000); -- Knight (Card) -- verified live xp
	elseif(e.other:GetFactionValue(e.self) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13321})) then -- Eye of Stormhammer
		...
		e.other:Faction(e.self,290, 5); -- Merchants of Kaladim
		e.other:Faction(e.self,232, -5); -- Craknek Warriors
		e.other:QuestReward(e.self,math.random(1,5),0,0,0,5415,5000); -- Avenger Battle Axe
	end
