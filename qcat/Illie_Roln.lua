...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 20205}) and expansion_flag >= 4.0) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 20177, item2 = 19946}) and expansion_flag >= 4.0) then
