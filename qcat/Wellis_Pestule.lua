...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 20206}) and expansion_flag >= 4.0) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 20188, item2 = 19946}) and expansion_flag >= 4.0) then
